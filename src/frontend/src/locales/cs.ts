export const csTranslations = {
  ...
  error: {
    ...
    recipeBindingError: 'Požadavek na recept se nepodařilo zpracovat',
    recipeAuthorIdInvalid: 'Neplatný autor receptu',
    recipeDataInvalid: 'Data receptu jsou neplatná',
    recipeDifficultyInvalid: 'Neplatná obtížnost receptu',
    recipeMealTypeInvalid: 'Neplatný typ jídla',
    recipeCantEdit: 'Tento recept nemůžete upravit',
    recipeCantDelete: 'Tento recept nemůžete smazat',
    recipeBadField: 'Jedno nebo více polí receptu je neplatných',

    userNotFound: 'Uživatel nebyl nalezen',
    userBindingError: 'Požadavek na uživatele se nepodařilo zpracovat',
    userUnauthorized: 'Nemáte oprávnění k této akci',
    userBadField: 'Jedno nebo více polí uživatele je neplatných',
    userNameInvalid: 'Neplatné jméno',
    userEmailInvalid: 'Neplatná e-mailová adresa',
    userUsernameInvalid: 'Neplatné uživatelské jméno',
    userPasswordInvalid: 'Neplatné heslo',
    userPasswordWeak: 'Heslo je příliš slabé',
    userPasswordChangeForbid: 'Změna hesla není povolena',
