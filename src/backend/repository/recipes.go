...
// Recipe DB functions needed:
// [TODO] GetAllRecipes     — GET /api/recipes (with filters: cuisine, meal_type, difficulty)
// [TODO] GetRecipeById     — GET /api/recipes/:id (joins steps + ingredients)
