export const fiTranslations = {
  ...
  error: {
    ...
    recipeMealTypeInvalid: 'Virheellinen ateriatyyppi',
    recipeCantEdit: 'Et voi muokata tätä reseptiä',
    recipeCantDelete: 'Et voi poistaa tätä reseptiä',
    ...
    userEmailInvalid: 'Virheellinen sähköpostiosoite',
    userUsernameInvalid: 'Virheellinen käyttäjänimi',
    userPasswordInvalid: 'Virheellinen salasana',
    userPasswordWeak: 'Salasana on liian heikko',
    userPasswordChangeForbid: 'Salasanan vaihtaminen ei ole sallittua',
    ...
    userQueryMissing: 'Kyselymerkkijono vaaditaan',
    userQueryTooLong: 'Kyselymerkkijono on liian pitkä',
    userQueryTooShort: 'Kyselymerkkijono on liian lyhyt',
    ...
    friendshipAlreadyExists: 'Olet jo yhteydessä tähän käyttäjään',
    friendshipReceiverNotFound: 'Valittua käyttäjää ei löytynyt',
    friendshipNoSelf: 'Et voi lähettää ystäväpyyntöä itsellesi',
